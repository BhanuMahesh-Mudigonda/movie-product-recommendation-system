...
from ml.intelligence.recommendation_signal_engine import generate_recommendation_signals
import os
import pickle
import re
...
def merge_movie_metadata(title, year=None):
    ...
    # Generate MovieMind intelligence from merged metadata
    intelligence = tag_movie_intelligence(merged_movie)

    merged_movie["moviemind_intelligence"] = intelligence

    # Generate recommendation signals from MovieMind intelligence
    recommendation_signals = generate_recommendation_signals(
        merged_movie
    )

    merged_movie["recommendation_signals"] = (
